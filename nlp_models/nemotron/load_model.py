...
def get_nemotron(lm_name, lm_size, lm_cache_dir, device_map='auto', precision=None, return_tokenizer_only=False):
    lm_size = lm_size.upper()
    if lm_name == "nemotron":
        name = f"nvidia/Llama-3.1-Nemotron-{lm_size}-Instruct-HF"
    else:
